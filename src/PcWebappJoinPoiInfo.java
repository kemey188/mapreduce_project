...
public class PcWebappJoinPoiInfo {
	...
	public static class MyMap extends MapReduceBase implements
		...
		public void map(LongWritable key, Text value,
	            ...
	            // input[0]文件输入  pc_webapp uid解密后的数据
	            // input_path.contains(main_path_feature)
	            if (filePath.contains("action_type=browse_pc_webapp_decode/")) {  
		            ...
		            output.collect( new Text(uid), new Text("src#"+event_date+"\t"+bdid+"\t"+uid+"\t"+event_tms+"\t"+action_name+"\t"+city+"\t"+province+"\t"+loc_x+"\t"+loc_y
		            		+"\t"+bizarea));  
	            }  
...
//		    }
	...
	public static void main(String[] args) throws Exception {
		...
		JobConf conf = new JobConf(PcWebappJoinPoiInfo.class);
		conf.setJobName("PcWebappJoinPoiInfo");
